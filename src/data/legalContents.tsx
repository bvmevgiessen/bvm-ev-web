...
export const impressumContent = (
  <div className="space-y-6 text-sm text-slate-700 leading-relaxed">
    ...
    <section>
      ...
      <p>Vorsitzender: Hakan Dönmez</p>
      <p>Stellvertretender Vorsitzender: Ömer Altun</p>
    </section>
    ...
    <section>
      ...
      <p>Vorstand BVM e.V.<br />Siemensstraße 18, 35394 Gießen</p>
    </section>
...
export const privacyContent = (
  <div className="space-y-6 text-sm text-slate-700 leading-relaxed">
    ...
    <section>
      <h3 className="text-lg font-extrabold text-brand-navy mb-2">12. Änderungen dieser Datenschutzerklärung</h3>
      <p>
